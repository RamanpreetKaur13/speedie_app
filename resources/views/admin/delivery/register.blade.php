            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center mb-6">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">Speedie</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-1">Speedie Delivery 🚀</h4>
              ...
              <form id="formAuthentication" class="mb-6" action="index.html">
                ...
                <div class="mb-6">
                  ...
                  <div class="mb-6">
                    ...
                    <input type="text" class="form-control" id="alternateNumber" name="alternateNumber" placeholder="Enter your alternateNumber" />
                  </div>
                  ...
                  <div class="mb-6">
                    ...
                    <input type="text" class="form-control" id="adhar" name="adhar" placeholder="Enter your adhar" />
                  </div>
                  <div class="mb-6">
                  ...
                  <div class="mb-6">
                    ...
                    <input type="text" class="form-control" id="drivingLicence" name="drivingLicence" placeholder="Enter your drivingLicence" />
                  </div>
                  <div class="mb-6">
                    <label for="deliveryBoyType" class="form-label">Delivery Boy Type</label>
                    <select name="deliveryBoyType" id="deliveryBoyType"  class="form-control" >
                  ...
                  <div class="mb-6">
                    ...
                    <input type="text" class="form-control" id="locationId" name="locationId" placeholder="Enter your locationId" />
                  </div>
