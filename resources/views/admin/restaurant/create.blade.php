                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    <div class="mb-6">
                                        <label class="form-label" for="delivery_radius">Delivery Radius <small>In km</small></label>
                          ...
                          <textarea
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    <div class="mb-6">
                                        <label class="form-label" for="average_cost_for_per_person">Avg. cost per person</label>
